        ...
        <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div className="max-w-xl">
            ...
            <div className="space-y-8 leading-relaxed text-lg text-justify">
              <p>
                For many of us, the kitchen is the heart and soul of the home. However, others spend very little time there. Whatever your routine, whatever your habits, the kitchen is the heart of your home. cabinets can customize Italian kitchen designs to meet your family's needs. It will provide comfort and ease while you cook, clean, or even eat in your home.
              </p>

              <p>
                There's a style for everyone, no matter what your preference is. You have the option of choosing from either traditional or modern designs. cabinets will help you design your perfect kitchen. You will find the right material, layout, or finishing for you. 
              </p>
            </div>
          </div>
      ...
      >
        ...
        >
          ...
          <div className="max-w-7xl mx-auto px-4 leading-relaxed text-left">
            ...
            <ul className="list-disc list-inside space-y-1">
              <li> Many people associate Italian kitchen design with rustic and old-world. However, this is not the only type of Italian kitchen. Italian kitchen design is not an exception. It has been well-known for its modern designs in recent years. </li>
              <li> Modern Italian kitchens are sleek and modern, featuring integrated appliances and a streamlined design. Modern Italian kitchens are extremely functional. They are the complete opposite of traditional Italian kitchens in terms of design.  </li>
              <li> Italian design can be anything from rustic and traditional to modern and sleek. You can incorporate elements of Italian design in your home, no matter what style you choose.   </li>            
            </ul>
          </div>
        </section>
        ...
        >
          ...
          <div className="max-w-7xl mx-auto px-4 leading-relaxed text-left">
            ...
            <ul className="list-disc list-inside space-y-1">
              <li><strong> Organized -</strong> A well-designed Italian kitchen design will provide easy access to all utensils with suitable storage. A vital component of any kitchen is the storage space. Italian kitchens use plenty of drawers to pull it out and storage units under the counter to store everything. It will be easy to prepare for guests by setting up the Kitchen in a well-organized manner.  </li>
              <li><strong> Stylish -</strong> The modular Kitchen's unique look and feel is a highlight. It's sleek and modern, yet elegant and simple. You have complete control over the Kitchen's appearance and feel thanks to the variety of finishes available, including engineered stone, metal, and laminate. The kitchen will look larger and brighter because of this.</li>
              <li><strong> Functional -</strong> Many kitchen design principles make it easier to move around and work in the Kitchen. One such principle is the working triangle or golden triangle. This theory states that the main work areas for the kitchen fridge, stovetop, and sink should all be at the three apex points. It is possible to make the Kitchen more user-friendly by using designs that are easy to use. </li>
              <li><strong> 	Easy to maintain -</strong> The modular Italian Kitchen's components are easily removed, making it easy to clean. Modular Kitchens are also made from resistant material rather than traditional wood. Modular Kitchens also have a lower maintenance cost. </li>
              <li><strong> Easy Installation -</strong> It is easy to install modular kitchens because many of them are manufactured in factories. If you plan well, you won't have to depend on the replacement kitchen for more than a week.  </li>
            </ul>
          </div>
        </section>
        ...
        >
          ...
          <div className="max-w-7xl mx-auto px-4 leading-relaxed text-left">
            ...
            <ul className="list-disc list-inside space-y-1 mt-6 mb-6">
              <li><strong>Budget: </strong> This is the most important feature of Italian Modular Kitchen. This allows you to select from a wide range of furniture materials.</li>
              <li><strong>Italian Kitchen Layout: </strong>You have the option to make your kitchen as personal or seek expert advice.</li>
