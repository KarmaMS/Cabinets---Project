        ...
        <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div className="max-w-xl">
            ...
            <div className="space-y-8 leading-relaxed text-lg text-justify">
              <p>
                Modular Kitchens are a modern, well-designed kitchen that uses modular storage cabinets. This allows for a hassle-free cooking experience and maximizes space. An Island Kitchen ideal layout is one that has a straight or L-shaped layout with a central Island.
              </p>

              <p>
                Although the Island is primarily a hob, it can be used as a dry-working area or breakfast table.
              </p>
            </div>
          </div>
      ...
      >
        ...
        >
          ...
          <div className="max-w-7xl mx-auto px-4 leading-relaxed text-left">
            ...
            <ul className="list-disc list-inside space-y-1">
              ...
              <li> These cabinets are available in Island kitchen designs with sliding or pocket doors. They not only increase storage space but also reduce visible clutter. </li>
            </ul>
          </div>
        </section>
        ...
        >
          ...
          <div className="max-w-7xl mx-auto px-4 leading-relaxed text-left">
            ...
            <ul className="list-disc list-inside space-y-1">
              ...
              <li>Designing an Island-line kitchen has been a success in terms of space management. This means that there is ample storage space without clutter.</li>
        ...
        >
          ...
          <div className="max-w-7xl mx-auto px-4 leading-relaxed text-left">
            ...
            <p className='mb-6'>The Island Modular Kitchen Designs are ideal for homes with enough space for a kitchen. The design of a kitchen is not a permanent task. However, Island modular kitchens are made of high-quality materials that make it easy to maintain.</p>

            <h2 className="text-w-4xl sm:text-l font-bold tracking-tight mb-4">
              <span className="text-gray-800"><strong>Essentials for designing an Island Kitchen </strong></span>
            </h2>

            <ul className="list-disc list-inside space-y-1 mt-6 mb-6">
              <li><strong>Budget: </strong>This is the most important aspect of Island Modular Kitchen. It allows you to choose from a variety of furniture materials.</li>
              <li><strong>Island Kitchen Layout: </strong>You can make your kitchen layout as personal as you like or get expert advice.</li>
              <li><strong>Material: </strong>Modular kitchens can be made from many materials, including wood, marble, and granite. You have the option to choose the material that best suits your needs and budget. </li>
            </ul>
          </div>
        </section>        
