        ...
        <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div className="max-w-xl">
            ...
            <div className="space-y-8 leading-relaxed text-lg text-justify">
              <p>
                These modular kitchens are versatile and can be used in many ways. This layout can be used to accommodate a dining table if the space is large enough. Properly arranging kitchen items can provide storage space in the corners.
              </p>

              <p>
                The ideal L shaped Kitchen has the hob located at the junction between the sink and fridge, creating a triangle that separates wet work from storage.
              </p>
            </div>
          </div>
      ...
      >
        ...
        >
          ...
          <div className="max-w-7xl mx-auto px-4 leading-relaxed text-left">
            ...
            <p className='mb-6'>Straight Modular Kitchens are packed with incredible features that allow you to enjoy the process of cooking. The straight line kitchens offer extra convenience with sliding and pocket doors, increasing storage space and reducing visible clutter.</p>
            <p>The work triangle is placed in the kitchen design. The location of the kitchen sink is so that users have the most space between them. A straight modular kitchen is designed to use the space to place the dining table in the kitchen. This will enhance the interactivity of the kitchen. </p>
          </div>
        </section>
        ...
        >
          ...
          <div className="max-w-7xl mx-auto px-4 leading-relaxed text-left">
            ...
            <ul className="list-disc list-inside space-y-1">
              ...
              <li> A straight-line kitchen design allows for space management to be done efficiently. This means that you have ample storage space without clutter.</li>
        ...
        >
          ...
          <div className="max-w-7xl mx-auto px-4 leading-relaxed text-left">
            ...
            <p className='mb-6'>Straight modular kitchen designs looks more good than regular ones, and they are very practical and easy to use. The design of a kitchen is not a permanent task. However, the problem of maintaining the kitchen's cleanliness can be solved by using top-quality materials and functionality in modular kitchens. </p>

            <h2 className="text-w-4xl sm:text-l font-bold tracking-tight mb-4">
              <span className="text-gray-800"><strong>Essentials for designing a straight kitchen </strong></span>
            </h2>

            <ul className="list-disc list-inside space-y-1 mt-6 mb-6">
              <li><strong>Budget: </strong>This is the most important factor in a straight-line kitchen. It eventually allows you to choose from a variety of furniture materials. </li>
              <li><strong>In-Line Kitchen Layout: </strong>You can make your kitchen layout as personal as you like or get expert advice.</li>
              <li><strong>Material: </strong>Modular kitchens can be made from many materials, including wood, marble, and granite. Choose the material that suits as per your needs and budget.</li>
            </ul>
          </div>
        </section>        
