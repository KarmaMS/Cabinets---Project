    ...
    <div className="pt-20">
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p className="mt-4 text-xl text-gray-500 text-center">Our designers and architects continuously keep track of the progress with a high degree of the utmost precision. They look at the architectural and customer's needs to turn the wardrobe and kitchen into a distinctive and feasible style.</p>
        </div>
